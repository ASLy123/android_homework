...
public class HuodongTestHolder extends RecyclerView.ViewHolder {
    ImageView img_recy_huodong;
    TextView txt_item_recy_name;
    TextView txt_item_recy_desc;
    GridView grid_item_recy;

    public HuodongTestHolder(@NonNull View itemView) {
        super(itemView);
        img_recy_huodong=itemView.findViewById(R.id.img_recy_huodong);
