...
public class QihangActivity extends AppCompatActivity {
    private QihJieshaoFragment qihJieshaoFragment;
    private QihZuanyeFragment qihZuanyeFragment;
    private QihShiziFragment qihShiziFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qihang);
        tab_test = findViewById(R.id.tab_test);
        pager_test = findViewById(R.id.pager_test);

        String[] tabtitles = {"学院介绍", "专业介绍", "师资介绍"};
        Fragment[] fragments2 = {new QihJieshaoFragment(), new QihZuanyeFragment(), new QihShiziFragment()};
        List<Map<String, Object>> list = new ArrayList<>();
        for (int i = 0; i < tabtitles.length; i++) {
            Map<String, Object> map = new HashMap<>();
            map.put("tab", tabtitles[i]);
            map.put("frag", fragments2[i]);
            list.add(map);
        }
