...
public class JianyiActivity extends AppCompatActivity {
    private JianyiJieshaoFragment jianyiJieshaoFragment;
    private JianyiZuanyeFragment jianyiZuanyeFragment;
    private JianyiShiziFragment jianyiShiziFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment[] fragments5 = {new JianyiJieshaoFragment(), new JianyiZuanyeFragment(), new JianyiShiziFragment()};
        for (int i = 0; i < tabtitles.length; i++) {
            Map<String, Object> map = new HashMap<>();
            map.put("tab", tabtitles[i]);
            map.put("frag", fragments5[i]);
            list.add(map);
        }
        //定义fragment管理器
