...
public class GongguiActivity extends AppCompatActivity {
    private GoguiJieshaoFragment goguiJieshaoFragment;
    private GoguiZuanyeFragment goguiZuanyeFragment;
    private GoguiShiziFragment goguiShiziFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gonggui);
        tab_test = findViewById(R.id.tab_test);
        pager_test = findViewById(R.id.pager_test);

        String[] tabtitles = {"学院介绍", "专业介绍", "师资介绍"};
        List<Map<String, Object>> list = new ArrayList<>();
        Fragment[] fragments1 = {new GoguiJieshaoFragment(), new GoguiZuanyeFragment(), new GoguiShiziFragment()};
        for (int i = 0; i < tabtitles.length; i++) {
            Map<String, Object> map = new HashMap<>();
            map.put("tab", tabtitles[i]);
            map.put("frag", fragments1[i]);
            list.add(map);
        }
